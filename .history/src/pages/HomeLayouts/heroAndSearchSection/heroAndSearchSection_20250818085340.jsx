...
{/* 🔵 Section 1: Banner + Search with overlay */}
<div
  className="relative bg-cover bg-center flex flex-col items-center justify-center inset-0 z-10"
...
>
  ...
  {/* Content */}
  <div className="relative p-5 max-w-2xl mx-auto text-center text-white">
    <h1 className="text-4xl font-bold">Welcome to the Pet Management Platform</h1>
    <p className="text-xl mt-2">Manage and explore pets easily with us</p>
    ...
    <div className="relative w-60 mx-auto mt-4">
      ...
      {searchTag && (
        <button
          ...
          className="absolute right-2 top-1/2 transform -translate-y-1/2 text-gray-300 hover:text-red-600"
          title="Clear"
        >
          &times;
        </button>
