...
<div className="flex space-x-2">
  {/* Github */}
  <button className="p-2 rounded text-indigo-600 transition hover:text-transparent hover:bg-gradient-to-r hover:from-indigo-500 hover:to-purple-500 hover:bg-clip-text">
    <Github className="w-5 h-5" />
  </button>

  {/* Twitter */}
  <button className="p-2 rounded text-indigo-600 transition hover:text-indigo-500">
