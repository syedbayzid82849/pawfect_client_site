                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex space-x-2">
                            <button className="p-2 rounded text-indigo-600 transition hover:bg-gradient-to-r hover:from-indigo-500 hover:to-purple-500 hover:bg-clip-text ">
                                <Github className="w-5 h-5" />
                            </button>
                            <button className="p-2 rounded text-indigo-600 transition">
